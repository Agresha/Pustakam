...
function FreeBooks() {
  ...
  const freeBooks = books.filter(book => book.book_price === 0).slice(0,10);
  ...
  return (
    <div
      className={`max-w-[1300px] mx-auto my-0 p-5 mb-16 ${
    ...
    >
      ...
      <div className="flex justify-between items-center mb-5">
        <h2 className="text-2xl">
          {getTranslation("Free Books", selectedLanguage)} {/* Use translation function here */}
        </h2>
